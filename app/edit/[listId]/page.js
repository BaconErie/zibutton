...
export default function EditListPage({ params }) {
  ...
  async function useEffectMain() {
    ...
    setVisibility(listInfo.visibility == 'public');
  }
  ...
  */
  ...
  async function handleListSubmit(e) {
    ...
    const res = await editExisitingList(params.listId, listName, visibility, characterList);
  ...
  return (<>
    <div>
      ...
      <form onSubmit={handleListSubmit}>
        ...
        <PrimaryButton type={'submit'} className={styles.submitList}>Save edits</PrimaryButton>
        <br /><br />
        {
