...
db.run('CREATE TABLE IF NOT EXISTS lists (id INTEGER PRIMARY KEY AUTOINCREMENT, ownerId INTEGER, ownerUsername TEXT, name TEXT, timeCreated INTEGER, lastUpdated INTEGER, visibility TEXT)');